...
document.writeln("    <link href=\'http://202.120.117.251/partner/8080/html/webui/css/head_style.css\' rel=\'stylesheet\' type=\'text/css\'/>");
document.writeln("    <link href=\'http://202.120.117.251/partner/8080/html/webui/js/layui/css/layui.css\' rel=\'stylesheet\' type=\'text/css\'/>");
document.writeln("    <script src=\'http://202.120.117.251/partner/8080/html/webui/js/layui/layui.all.js\'></script>");
document.writeln("    <script type=\'text/javascript\' src=\'http://202.120.117.251/partner/8080/html/webui/js/interceptor.js\'></script>");
document.writeln("</head>");
...
document.writeln("        </a>");*/
/*logo*/
document.writeln("<img src=\"http://202.120.117.251/partner/8080/html/webui/images/header_img/logo01.png\" style=\"margin-left: 0;\"  width=\"256px\" height=\"100%\">");
document.writeln("<img src=\"http://202.120.117.251/partner/8080/html/webui/images/header_img/logo02.png\" width=\"70px\" height=\"100%\">");

document.writeln(" <div class=\'aui-top-nav\' style='left: 30%'>");
document.writeln("            <ul class=\'menu\'>");
document.writeln("                <li class=\'product\'>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/index.html\'>");
document.writeln("                        首页");
document.writeln("                        <span class=\'u-icon-caret\'></span>");
document.writeln("                    </a>");
document.writeln("                </li>");
document.writeln("                <li class=\'finance\'>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/leasson/leasson.html\'>");
document.writeln("                        课程");
document.writeln("                        <span class=\'u-icon-caret\'></span>");
document.writeln("                    </a>");
document.writeln("                </li>");
document.writeln("                <li>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/project/project.html\'>");
document.writeln("                        项目");
document.writeln("                    </a>");
document.writeln("                </li>");
document.writeln("                <li class=\'price\'>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/activity/activity02.html\'>");
document.writeln("                        活动");
document.writeln("                        <span class=\'u-icon-caret\'></span>");
document.writeln("                    </a>");
document.writeln("                </li>");
...
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/live/live.html\'>直播");
document.writeln("                    </a>");
document.writeln("                </li>");
document.writeln("                <li class=\'merchants\'>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/news/news.html\'>上大社区");
document.writeln("                    </a>");
document.writeln("                </li>");
document.writeln("                <li class=\'college\'>");
document.writeln("                    <a href=\'http://202.120.117.251/partner/8080/html/webui/supervisor/supervisor.html\'>导师");
document.writeln("                    </a>");
document.writeln("                </li>");
